...
- Massage theo hướng đi lên và ra ngoài`,
    ...
    // ============================================================
    {
      ...
      category: 'Cấp ẩm',
      question: 'Cấp ẩm',
      answer: `Chúng tôi khuyên dùng **RED 7** cho da khô
...
✅ Có thể sử dụng nhiều sản phẩm EXOBIO cùng nhau!`,
    ...
    {
      id: 'usage-04',
      keywords: ['cách dùng MTS', 'MTS', 'con lăn da', 'kim lăn'],
      category: 'Cách sử dụng',
      question: 'Cách dùng MTS',
      answer: `🔬 **Cách sử dụng MTS (Con lăn da)**

📋 **Cách sử dụng**:
**01.** Trước khi sử dụng, ngâm con lăn da (MTS) trong ethanol khử trùng trong 5-10 phút để khử trùng kỹ lưỡng.

**02.** Sau khi làm sạch mặt bằng sữa rửa mặt, chuẩn bị làn da của bạn.

**03.** Thoa tinh chất Exosome EXOBIO lên da một cách hào phóng.

**04.** Lăn con lăn da nhẹ nhàng trên vùng mong muốn với áp lực đều đặn. Lặp lại cho đến khi bạn cảm thấy một sự kích thích nhẹ trên da.

**05.** Vỗ nhẹ tinh chất còn lại để hấp thụ, sau đó hoàn thành với kem dưỡng da trên làn da đỏ.

⚠️ **Hướng dẫn sử dụng**:
• MTS về nguyên tắc là sản phẩm dùng một lần, tối đa có thể sử dụng 3 lần.
• Khi tái sử dụng, hãy chắc chắn khử trùng kỹ lưỡng mỗi lần trước khi sử dụng.
• Khuyến nghị sử dụng 1 lần mỗi 3-4 tuần.

💡 **Hiệu quả**: Khi sử dụng với tinh chất Exosome, tỷ lệ hấp thụ của da tăng lên để có kết quả tốt hơn!`,
      relatedQuestions: ['Cách sử dụng', 'Sử dụng kết hợp'],
...
- Nhiều mối quan tâm → Có thể kết hợp 2-3!`,
    ...
    },
    {
      ...
      answer: `Danh mục sản phẩm EXOBIO

💎 **Dòng cao cấp EXOSOME (Chăm sóc tập trung nồng độ cao)**
...
💡 **Đặc điểm sản phẩm**:
- EXOSOME: Cải thiện nhanh với thành phần nồng độ cao
- RED: Có thể sử dụng hàng ngày mà không gánh nặng

🎁 **Lợi ích bổ sung**:
- Chẩn đoán da AI: Miễn phí (https://curetembio.xyz)
- Liên hệ: curetembio@gmail.com

💰 **Hỏi giá**: Có thể kiểm tra tại trung tâm mua sắm hoặc nhà thuốc`,
...
🇯🇵 Qoo10 NHẬT BẢN: https://www.qoo10.jp/shop/EXOBIO (Tiếng Nhật)
...
💡 Vui lòng nhấp vào các nút trả lời nhanh để xem thông tin chi tiết!`,
  ...
  quickReplyKeywords: [
    ...
    { label: '🔬 Cách dùng MTS', query: 'cách dùng MTS' },
