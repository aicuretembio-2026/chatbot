...
- Masajee de abajo hacia arriba, de adentro hacia afuera`,
    ...
    // ========================================
    {
      ...
      answer: `Para piel seca, recomendamos **RED 5**.
...
💡 **Nota**: ¡Puedes usar varios productos EXOBIO juntos!`,
    ...
    {
      id: 'usage-04',
      keywords: ['rodillo MTS', 'microagujas', 'rodillo de agujas', 'dermaroller'],
      category: 'Uso',
      question: 'Uso del rodillo MTS',
      answer: `Uso del rodillo derma MTS con EXOBIO

🎯 **¿Qué es el rodillo MTS?**
- Rodillo de microagujas (0.25mm o menos)
- Aumenta la tasa de absorción de la piel
- Herramienta de gestión cutánea en casa

✅ **Método de uso de EXOBIO + rodillo MTS**
1. Limpieza facial
2. Usar **rodillo MTS** (1-2 veces/mes)
3. Aplicar **ampolla EXOBIO**
4. Resto del cuidado de la piel

💡 **Efectos**:
- Gran aumento de la tasa de absorción
- Sensación de efectos más rápidos
- Efectos similares a procedimientos dermatológicos

⚠️ **Precauciones**:
- Usar rodillo de 0.25mm o menos
- Prohibido uso excesivo (1-2 veces/mes)
- Evitar en piel problemática`,
