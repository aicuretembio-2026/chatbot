...
💡 **参考**: 複数のEXOBIO製品を一緒に使用しても大丈夫です！`,
    ...
    {
      id: 'usage-04',
      keywords: ['MTSローラー', 'マイクロニードル', '針ローラー', 'ダーマローラー'],
      category: '使用方法',
      question: 'MTSローラー使用',
      answer: `MTSローラーとEXOBIO一緒に使用

🎯 **MTSローラーとは？**
- マイクロニードル (0.25mm以下) ローラー
- 皮膚吸収率を高める
- 家庭用皮膚管理ツール
...
🔬 **EXOSOME シリーズ (集中ケア)**
- EXOSOME 3 (美白・色素改善): 80,000ウォン (5ml × 5個)
- EXOSOME 5 (しわ・弾力): 80,000ウォン (5ml × 5個)
- EXOSOME 7 (鎮静・保湿): 80,000ウォン (5ml × 5個)

💧 **RED シリーズ (デイリーケア)**
- RED 3 (デイリー美白): 33,000ウォン (15ml × 2本)
- RED 5 (デイリー弾力): 37,000ウォン (15ml × 2本)
- RED 7 (デイリー鎮静): 32,000ウォン (15ml × 2本)
...
💡 **コストパフォーマンス**
- **EXOSOME**: 1回分 16,000ウォン (週3-4回、約1-1.5ヶ月使用)
- **RED**: 1日あたり約550-620ウォン (毎日使用)
- 皮膚科の施術より経済的な自宅専門ケア
- リピート購入率61% - 効果を実感したお客様が再購入

🎁 **推奨併用**
EXOSOME (週3-4回集中ケア) + RED (毎日ベースケア) を併用すると、最高の効果が得られます。
...
🌐 公式ホームページ: https://www.exobio.net/`,
  ...
  quickReplies: [
    // 🛒 購入方法 (最優先)
    { text: '🛒 購入方法', query: '製品購入方法' },
    
    // 肌悩み - しわ/老化 (4個)
    { text: '💫 シワ', query: 'しわ' },
    { text: '💫 小ジワ', query: '小じわ' },
    { text: '💫 目元のシワ', query: '目元のしわ' },
    { text: '💫 ほうれい線', query: 'ほうれい線' },
    
    // 肌悩み - 美白/シミ (4個)
    { text: '💎 美白', query: '美白' },
    { text: '✨ シミ', query: 'しみ' },
    { text: '💎 色素沈着', query: '色素沈着' },
    { text: '💎 くすみ', query: 'くすみ' },
    
    // 肌悩み - ニキビ/トラブル (4個)
    { text: '🔴 ニキビ', query: 'ニキビ' },
    { text: '🔴 吹き出物', query: '吹き出物' },
    { text: '🔴 肌荒れ', query: '肌トラブル' },
    { text: '🔴 ニキビ跡', query: 'ニキビ跡' },
    
    // 肌悩み - 鎮静/敏感性 (5個)
    { text: '🌸 赤み', query: '赤み' },
    { text: '🌿 鎮静', query: '鎮静' },
    { text: '🌸 敏感肌', query: '敏感' },
    { text: '🛡️ バリア', query: '皮膚バリア' },
    { text: '🛡️ バリア強化', query: '皮膚バリア' },
    
    // 肌悩み - 弾力/たるみ (3個)
    { text: '🌟 弾力', query: '弾力' },
    { text: '🌟 たるみ', query: '顔のたるみ' },
    { text: '🌟 リフティング', query: 'リフティング' },
    ...
    { text: '🎯 推奨', query: 'おすすめ' },
    { text: '🔄 違い', query: '違い' },
    { text: '💡 EXOBIOとは?', query: 'EXOBIOとは' },
    { text: '✅ 効能', query: '効能' },
    { text: '🔢 番号の意味', query: '357' },
    { text: '💰 価格', query: '価格' },
    { text: '🧪 成分', query: '成分' },
...
下のクイックリプライボタンをクリックすると便利です！ 👇`,
  ...
  quickReplyKeywords: [
    // 購入方法
    { label: '🛒 購入方法', query: '購入方法' },
    
    // シワ/老化
    { label: '💫 シワ', query: 'シワ' },
    { label: '💫 細かいシワ', query: '細かいシワ' },
    { label: '💫 深いシワ', query: '深いシワ' },
    { label: '💫 目元のシワ', query: '目元のシワ' },
    ...
    { label: '🌿 鎮静', query: '鎮静' },
    { label: '🌸 敏感肌', query: '敏感肌' },
    { label: '🛡️ 皮膚バリア', query: '皮膚バリア' },
    { label: '🛡️ バリア強化', query: 'バリア強化' },
