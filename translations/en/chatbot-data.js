...
- Massage upward and outward`,
    ...
    // ============================================================
    {
      ...
      category: 'Hydration',
      question: 'Hydration',
      answer: `We recommend **RED 5** for dry skin.
...
💡 **TIP**: EXOSOME 7 (3-4 times/week) + RED 7 (daily) combination for faster results!`,
  ...
  quickReplies: [
    ...
    { text: '🛒 How to Buy', query: 'purchase' },
    
    // Skin Concerns - Wrinkles/Aging (4)
    { text: '💫 Wrinkles', query: 'wrinkles' },
    { text: '💫 Fine Lines', query: 'fine lines' },
    { text: '💫 Eye Wrinkles', query: 'eye wrinkles' },
    { text: '💫 Nasolabial Folds', query: 'nasolabial folds' },
    
    // Skin Concerns - Whitening/Pigmentation (4)
    { text: '💎 Whitening', query: 'whitening' },
    { text: '✨ Melasma', query: 'melasma' },
    { text: '💎 Hyperpigmentation', query: 'hyperpigmentation' },
    { text: '💎 Dullness', query: 'dullness' },
    
    // Skin Concerns - Acne/Trouble (4)
    { text: '🔴 Acne', query: 'acne' },
    { text: '🔴 Pimples', query: 'pimples' },
    { text: '🔴 Trouble', query: 'trouble' },
    { text: '🔴 Scars', query: 'acne scars' },
    
    // Skin Concerns - Soothing/Sensitive (5)
    { text: '🌸 Rosacea', query: 'rosacea' },
    { text: '🌿 Soothing', query: 'soothing' },
    { text: '🌸 Sensitive', query: 'sensitive' },
    { text: '🛡️ Barrier', query: 'skin barrier' },
    { text: '🛡️ Barrier Care', query: 'barrier strengthening' },
    
    // Skin Concerns - Elasticity/Sagging (3)
    { text: '🌟 Elasticity', query: 'elasticity' },
    { text: '🌟 Sagging', query: 'sagging' },
    { text: '🌟 Lifting', query: 'lifting' },
    
    // Skin Concerns - Hydration/Moisture (3)
    { text: '💧 Hydration', query: 'hydration' },
    { text: '💧 Dry Skin', query: 'dry skin' },
    { text: '💧 Moisture', query: 'moisture' },
    
    // Skin Concerns - Pores (2)
    { text: '🔹 Pores', query: 'pores' },
    { text: '🔹 Sebum', query: 'sebum' },
    
    // Product Information (8)
    { text: '🎯 Recommendation', query: 'recommendation' },
    { text: '📊 EXOSOME vs RED', query: 'difference' },
    { text: '🏥 About EXOBIO', query: 'EXOBIO' },
    { text: '✨ Efficacy', query: 'efficacy' },
    { text: '📖 How to Use', query: 'how to use' },
    { text: '🔢 Number 3·5·7', query: '357' },
    { text: '💰 Price', query: 'price' },
    
    // Safety (2)
    { text: '⚠️ Side Effects', query: 'side effects' },
    { text: '🧪 Ingredients', query: 'ingredients' },
